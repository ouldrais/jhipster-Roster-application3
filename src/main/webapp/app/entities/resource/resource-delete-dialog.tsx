...
export const ResourceDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterRosterApplication3App.resource.delete.question">
        <Translate contentKey="jhipsterRosterApplication3App.resource.delete.question" interpolate={{ id: resourceEntity.id }}>
