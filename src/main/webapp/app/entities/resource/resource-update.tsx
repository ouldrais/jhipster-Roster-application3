  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterRosterApplication3App.resource.home.createOrEditLabel" data-cy="ResourceCreateUpdateHeading">
            <Translate contentKey="jhipsterRosterApplication3App.resource.home.createOrEditLabel">Create or edit a Resource</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField
                  ...
                  readOnly
                  id="resource-id"
                  label={translate('jhipsterRosterApplication3App.resource.id')}
                  validate={{ required: true }}
                />
              ) : null}
              <ValidatedField
                label={translate('jhipsterRosterApplication3App.resource.key')}
                id="resource-key"
                name="key"
                data-cy="key"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterRosterApplication3App.resource.firstName')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterRosterApplication3App.resource.lastName')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterRosterApplication3App.resource.teamRole')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterRosterApplication3App.resource.exchangeAllowed')}
              ...
              <ValidatedField
                ...
                label={translate('jhipsterRosterApplication3App.resource.resourceTraining')}
                type="select"
              >
                <option value="" key="0" />
                {resourceTrainings
              ...
              <ValidatedField
                ...
                label={translate('jhipsterRosterApplication3App.resource.resourcePlan')}
                type="select"
              >
                <option value="" key="0" />
                {resourcePlans
