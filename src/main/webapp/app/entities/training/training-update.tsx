  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterRosterApplication3App.training.home.createOrEditLabel" data-cy="TrainingCreateUpdateHeading">
            <Translate contentKey="jhipsterRosterApplication3App.training.home.createOrEditLabel">Create or edit a Training</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField
                  ...
                  readOnly
                  id="training-id"
                  label={translate('jhipsterRosterApplication3App.training.id')}
                  validate={{ required: true }}
                />
              ) : null}
              <ValidatedField
                label={translate('jhipsterRosterApplication3App.training.key')}
                id="training-key"
                name="key"
                data-cy="key"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterRosterApplication3App.training.description')}
              ...
              <ValidatedField
                ...
                label={translate('jhipsterRosterApplication3App.training.positionRequirement')}
                type="select"
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                label={translate('jhipsterRosterApplication3App.training.resourceTraining')}
                type="select"
              >
                <option value="" key="0" />
                {resourceTrainings
