  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterRosterApplication3App.team.home.createOrEditLabel" data-cy="TeamCreateUpdateHeading">
            <Translate contentKey="jhipsterRosterApplication3App.team.home.createOrEditLabel">Create or edit a Team</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField
                  ...
                  readOnly
                  id="team-id"
                  label={translate('jhipsterRosterApplication3App.team.id')}
                  validate={{ required: true }}
                />
              ) : null}
              <ValidatedField
                label={translate('jhipsterRosterApplication3App.team.key')}
                id="team-key"
                name="key"
                data-cy="key"
                type="text"
              ...
              <ValidatedField
                ...
                name="resource"
                data-cy="resource"
                label={translate('jhipsterRosterApplication3App.team.resource')}
                type="select"
              >
                <option value="" key="0" />
                {resources
              ...
              <ValidatedField
                ...
                name="teamPlan"
                data-cy="teamPlan"
                label={translate('jhipsterRosterApplication3App.team.teamPlan')}
                type="select"
              >
                <option value="" key="0" />
                {teamPlans
