...
export const TeamDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterRosterApplication3App.team.delete.question">
        <Translate contentKey="jhipsterRosterApplication3App.team.delete.question" interpolate={{ id: teamEntity.id }}>
