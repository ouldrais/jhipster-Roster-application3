  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterRosterApplication3App.position.home.createOrEditLabel" data-cy="PositionCreateUpdateHeading">
            <Translate contentKey="jhipsterRosterApplication3App.position.home.createOrEditLabel">Create or edit a Position</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField
                  ...
                  readOnly
                  id="position-id"
                  label={translate('jhipsterRosterApplication3App.position.id')}
                  validate={{ required: true }}
                />
              ) : null}
              <ValidatedField
                label={translate('jhipsterRosterApplication3App.position.key')}
                id="position-key"
                name="key"
                data-cy="key"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterRosterApplication3App.position.leadership')}
              ...
              <ValidatedField
                ...
                label={translate('jhipsterRosterApplication3App.position.positionRequirement')}
                type="select"
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                label={translate('jhipsterRosterApplication3App.position.resourcePlan')}
                type="select"
              >
                <option value="" key="0" />
                {resourcePlans
