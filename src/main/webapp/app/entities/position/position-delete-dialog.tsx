...
export const PositionDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterRosterApplication3App.position.delete.question">
        <Translate contentKey="jhipsterRosterApplication3App.position.delete.question" interpolate={{ id: positionEntity.id }}>
