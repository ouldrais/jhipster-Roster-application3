...
export const ShiftTemplateDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterRosterApplication3App.shiftTemplate.delete.question">
        <Translate contentKey="jhipsterRosterApplication3App.shiftTemplate.delete.question" interpolate={{ id: shiftTemplateEntity.id }}>
