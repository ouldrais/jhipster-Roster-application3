  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterRosterApplication3App.shiftTemplate.home.createOrEditLabel" data-cy="ShiftTemplateCreateUpdateHeading">
            <Translate contentKey="jhipsterRosterApplication3App.shiftTemplate.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterRosterApplication3App.shiftTemplate.key')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterRosterApplication3App.shiftTemplate.shiftStart')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterRosterApplication3App.shiftTemplate.shiftEnd')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterRosterApplication3App.shiftTemplate.type')}
