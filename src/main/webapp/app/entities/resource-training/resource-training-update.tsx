  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterRosterApplication3App.resourceTraining.home.createOrEditLabel" data-cy="ResourceTrainingCreateUpdateHeading">
            <Translate contentKey="jhipsterRosterApplication3App.resourceTraining.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterRosterApplication3App.resourceTraining.status')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterRosterApplication3App.resourceTraining.level')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterRosterApplication3App.resourceTraining.trainer')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterRosterApplication3App.resourceTraining.activeFrom')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterRosterApplication3App.resourceTraining.activeto')}
