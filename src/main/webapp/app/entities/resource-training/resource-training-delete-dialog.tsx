...
export const ResourceTrainingDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterRosterApplication3App.resourceTraining.delete.question">
        <Translate
          contentKey="jhipsterRosterApplication3App.resourceTraining.delete.question"
          interpolate={{ id: resourceTrainingEntity.id }}
        >
