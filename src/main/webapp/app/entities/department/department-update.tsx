  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterRosterApplication3App.department.home.createOrEditLabel" data-cy="DepartmentCreateUpdateHeading">
            <Translate contentKey="jhipsterRosterApplication3App.department.home.createOrEditLabel">Create or edit a Department</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField
                  ...
                  readOnly
                  id="department-id"
                  label={translate('jhipsterRosterApplication3App.department.id')}
                  validate={{ required: true }}
                />
              ) : null}
              <ValidatedField
                label={translate('jhipsterRosterApplication3App.department.key')}
                id="department-key"
                name="key"
                data-cy="key"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterRosterApplication3App.department.team')}
                id="department-team"
                name="team"
                data-cy="team"
                type="text"
              ...
              <ValidatedField
                ...
                name="position"
                data-cy="position"
                label={translate('jhipsterRosterApplication3App.department.position')}
                type="select"
              >
                <option value="" key="0" />
                {positions
              ...
              <ValidatedField
                ...
                name="shiftDemand"
                data-cy="shiftDemand"
                label={translate('jhipsterRosterApplication3App.department.shiftDemand')}
                type="select"
              >
                <option value="" key="0" />
                {shiftDemands
