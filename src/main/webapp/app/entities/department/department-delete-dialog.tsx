...
export const DepartmentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterRosterApplication3App.department.delete.question">
        <Translate contentKey="jhipsterRosterApplication3App.department.delete.question" interpolate={{ id: departmentEntity.id }}>
