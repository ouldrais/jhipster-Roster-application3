...
export const TeamPlanDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterRosterApplication3App.teamPlan.delete.question">
        <Translate contentKey="jhipsterRosterApplication3App.teamPlan.delete.question" interpolate={{ id: teamPlanEntity.id }}>
