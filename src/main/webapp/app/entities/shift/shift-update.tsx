  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterRosterApplication3App.shift.home.createOrEditLabel" data-cy="ShiftCreateUpdateHeading">
            <Translate contentKey="jhipsterRosterApplication3App.shift.home.createOrEditLabel">Create or edit a Shift</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterRosterApplication3App.shift.key')}
                id="shift-key"
                name="key"
                data-cy="key"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterRosterApplication3App.shift.shiftStart')}
                id="shift-shiftStart"
                name="shiftStart"
                data-cy="shiftStart"
                type="datetime-local"
              ...
              />
              <ValidatedField
                label={translate('jhipsterRosterApplication3App.shift.shiftEnd')}
                id="shift-shiftEnd"
                name="shiftEnd"
                data-cy="shiftEnd"
                type="datetime-local"
              ...
              />
              <ValidatedField
                label={translate('jhipsterRosterApplication3App.shift.type')}
                id="shift-type"
                name="type"
                data-cy="type"
                type="text"
              ...
              <ValidatedField
                ...
                name="teamPlan"
                data-cy="teamPlan"
                label={translate('jhipsterRosterApplication3App.shift.teamPlan')}
                type="select"
              >
                <option value="" key="0" />
                {teamPlans
              ...
              <ValidatedField
                ...
                name="shiftDemand"
                data-cy="shiftDemand"
                label={translate('jhipsterRosterApplication3App.shift.shiftDemand')}
                type="select"
              >
                <option value="" key="0" />
                {shiftDemands
              ...
              <ValidatedField
                ...
                label={translate('jhipsterRosterApplication3App.shift.resourcePlan')}
                type="select"
              >
                <option value="" key="0" />
                {resourcePlans
