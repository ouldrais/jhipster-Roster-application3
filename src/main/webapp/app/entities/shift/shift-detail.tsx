    ...
    <Row>
      <Col md="8">
        <h2 data-cy="shiftDetailsHeading">
          <Translate contentKey="jhipsterRosterApplication3App.shift.detail.title">Shift</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="jhipsterRosterApplication3App.shift.teamPlan">Team Plan</Translate>
          </dt>
