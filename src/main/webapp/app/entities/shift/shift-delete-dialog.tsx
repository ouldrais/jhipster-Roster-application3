...
export const ShiftDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterRosterApplication3App.shift.delete.question">
        <Translate contentKey="jhipsterRosterApplication3App.shift.delete.question" interpolate={{ id: shiftEntity.id }}>
