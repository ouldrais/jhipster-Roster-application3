  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterRosterApplication3App.shiftDemand.home.createOrEditLabel" data-cy="ShiftDemandCreateUpdateHeading">
            <Translate contentKey="jhipsterRosterApplication3App.shiftDemand.home.createOrEditLabel">
              Create or edit a ShiftDemand
            </Translate>
          </h2>
        </Col>
      </Row>
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterRosterApplication3App.shiftDemand.count')}
