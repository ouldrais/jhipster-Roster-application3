  ...
  return (
    <div>
      <h2 id="position-requirement-heading" data-cy="PositionRequirementHeading">
        <Translate contentKey="jhipsterRosterApplication3App.positionRequirement.home.title">Position Requirements</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="jhipsterRosterApplication3App.positionRequirement.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link
          ...
          >
            ...
            &nbsp;
            <Translate contentKey="jhipsterRosterApplication3App.positionRequirement.home.createLabel">
        ...
        {positionRequirementList && positionRequirementList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="jhipsterRosterApplication3App.positionRequirement.id">ID</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('mandatoty')}>
                  <Translate contentKey="jhipsterRosterApplication3App.positionRequirement.mandatoty">Mandatoty</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterRosterApplication3App.positionRequirement.home.notFound">
