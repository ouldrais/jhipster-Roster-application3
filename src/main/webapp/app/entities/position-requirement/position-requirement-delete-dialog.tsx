...
export const PositionRequirementDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterRosterApplication3App.positionRequirement.delete.question">
        <Translate
          contentKey="jhipsterRosterApplication3App.positionRequirement.delete.question"
