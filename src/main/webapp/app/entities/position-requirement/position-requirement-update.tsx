  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2
            id="jhipsterRosterApplication3App.positionRequirement.home.createOrEditLabel"
            data-cy="PositionRequirementCreateUpdateHeading"
          >
            <Translate contentKey="jhipsterRosterApplication3App.positionRequirement.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterRosterApplication3App.positionRequirement.mandatoty')}
