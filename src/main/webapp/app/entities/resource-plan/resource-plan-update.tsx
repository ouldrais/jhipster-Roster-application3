  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterRosterApplication3App.resourcePlan.home.createOrEditLabel" data-cy="ResourcePlanCreateUpdateHeading">
            <Translate contentKey="jhipsterRosterApplication3App.resourcePlan.home.createOrEditLabel">
              Create or edit a ResourcePlan
            </Translate>
          </h2>
        </Col>
      </Row>
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterRosterApplication3App.resourcePlan.availability')}
