  ...
  return (
    <div>
      <h2 id="resource-plan-heading" data-cy="ResourcePlanHeading">
        <Translate contentKey="jhipsterRosterApplication3App.resourcePlan.home.title">Resource Plans</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="jhipsterRosterApplication3App.resourcePlan.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/resource-plan/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhipsterRosterApplication3App.resourcePlan.home.createLabel">Create new Resource Plan</Translate>
          </Link>
        </div>
      </h2>
        ...
        {resourcePlanList && resourcePlanList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="jhipsterRosterApplication3App.resourcePlan.id">ID</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('availability')}>
                  <Translate contentKey="jhipsterRosterApplication3App.resourcePlan.availability">Availability</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterRosterApplication3App.resourcePlan.home.notFound">No Resource Plans found</Translate>
            </div>
          )
        )}
      </div>
