...
export const ResourcePlanDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterRosterApplication3App.resourcePlan.delete.question">
        <Translate contentKey="jhipsterRosterApplication3App.resourcePlan.delete.question" interpolate={{ id: resourcePlanEntity.id }}>
